#ifndef ISLANDGAME_LEV_H
#define ISLANDGAME_LEV_H
...
//    tinyxml2::XMLDocument document_tsx;
//
...
//    auto image = root_element->FirstChildElement("image");
...
//
//    ///Проверка//////////////////////////////////////////////////////////////////////
//    sf::Texture map_three;
//    if (!map_three.loadFromFile("../Client/srcClient/images/map.png"))
//        return false;
//
//    path = "../Client/srcClient/images/map.png";
//    /////////////////////////////////////////////////////////////////////////////////
//
